...
//Kenny add struct for ExternalMemory (LDV/STV)            
/*
struct ExternalMemory
{
  u32bit address;
  f32bit data[4];
  struct ExternalMemory *nextEntry;
};
*/
...
private:
	...
	/**
	 *	Kenny dump register to a file
	 */
     
	void updatedumpfile(ShaderEmulator &shEmul);
	int Diff50and11(ShaderEmulator &shEmul);
	void dumpifIwanna(ShaderEmulator &shEmul);
    ...
    static void shLDV(ShaderInstruction::ShaderInstructionDecoded &shInstr, ShaderEmulator &shEmul);
    static void shSTV(ShaderInstruction::ShaderInstructionDecoded &shInstr, ShaderEmulator &shEmul);
...
public:
    ...
    *
     ...
     */
	 ...
	 bool checkJump(ShaderInstruction::ShaderInstructionDecoded *shInstrDec);
