...
//kenny change to support uniform matrix index 100+
static const GLenum MAX_PROGRAM_LOCAL_PARAMETERS_ARB    = 256;
//static const GLenum MAX_PROGRAM_PARAMETERS_ARB          = 256;
