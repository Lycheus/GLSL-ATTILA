...
ACDShaderProgram* ARBProgramObject::compileAndResolve(acdlib::ACDXFixedPipelineState* fpState)
{
	...
	// kenny add to dump the local params
	//cout << "dump LOCAL directSource: " << directSource[0] << " " << directSource[1] << " " << directSource[2] << " " << directSource[3] << " " << endl;        
	...
	//cout << "dump ENV directSource: " << directSource[0] << " " << directSource[1] << " " << directSource[2] << " " << directSource[3] << " " << endl;
...
//cout << "kenny print _shader Constants:\n";
//_shader->printConstants(cout);
