...
//kenny defins max register count
#define MAX_REG_COUNT 1000

using namespace std;
using namespace agl;

ARBRegisterBank::ARBRegisterBank(GLuint registerCount) : _RegisterCount(MAX_REG_COUNT)
{
    _registers = new _Register[MAX_REG_COUNT];
    for(GLuint reg = 0; reg < MAX_REG_COUNT; reg++)
