...
GLuint GLTextureObject::getSize(GLenum openGLType)
{
    switch ( openGLType )
    {
      //kenny I already cast the 5_6_5 "components" into unsigned byte@ AGLEntryPoints.cpp::1371
        case GL_BYTE:
                                    ...
                                    GLsizei width, GLsizei height)
{
	...
	/*
	else if ( ics == GL_UNSIGNED_SHORT_5_6_5 )
	{
	  if ( input != NULL)
	    {
