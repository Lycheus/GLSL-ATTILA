...
// kenny add to support shader program 2.0
...
// Kenny modify glProgramEnvParameter4fvARB cope with .cpp file
GLAPI void GLAPIENTRY AGL_glProgramEnvParameter4fvARB (GLenum target, GLuint index, const GLfloat *params);
//GLAPI void GLAPIENTRY AGL_glProgramEnvParameter4fvARB (GLenum target, GLuint index, const GLfloat x, GLfloat y, GLfloat z, GLfloat w); // this is new one but fail
