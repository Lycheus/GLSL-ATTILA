...
void GLTraceDriver::_setAGLFunctions()
{
    ...
    jt.glUseProgram = AGL_glUseProgram; //kenny add to jump table
    jt.glAttachShader = AGL_glAttachShader; // kenny add to jump table
    jt.glUniform1f = AGL_glUniform1f; // kenny add to jump table
    jt.glUniform1i = AGL_glUniform1i; // kenny add to jump table
    jt.glUniform2f = AGL_glUniform2f; // kenny add to jump table
    jt.glUniform3fv = AGL_glUniform3fv; // kenny add to jump table
    jt.glUniformMatrix3fv = AGL_glUniformMatrix3fv; // kenny add to jump table
    jt.glUniformMatrix4fv = AGL_glUniformMatrix4fv; // kenny add to jump table
