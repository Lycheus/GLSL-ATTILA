...
TOK_POINTSIZE TOK_POINT_POINT TOK_ENV TOK_LOCAL TOK_JMP
...
%type <irinstruction> instruction ARL_instruction JMP_instruction
...
/* end add */
    ...
    ;
/* kenny add JMP_instruction */
    JMP_instruction      : TOK_JMP maskedAddrReg ',' scalarSrcReg
        {
            $$ = new IRInstruction($1.linea,string($1.texto->c_str()));
            $2->setLine($$->getLine());
            $4->setLine($$->getLine());
...
vtxOptWeightNum  : { $$ = 0; }
//       {
//            $$ = 0; // Default value    This is the epsilon case. I don't 
//        }           // know why it did the $$ = 0 twice.
