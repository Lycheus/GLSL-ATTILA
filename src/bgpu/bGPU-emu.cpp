...
int main(int argc, char *argv[])
{
    ...
    //Kenny add to remove any ExternalMemory.dat which is for LDV/STV instruction emulation.
    //cout << "Remove ExternalMemory.dat\n";
    //system("rm ExternalMemory.dat");
    //end kenny add
